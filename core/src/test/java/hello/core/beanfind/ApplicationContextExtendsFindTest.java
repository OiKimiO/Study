...
public class ApplicationContextExtendsFindTest {
	...
	@Test
	@DisplayName("부모 타입으로 조회시, 자식이 둘 이상있으면 중복오류가 발생")
	...
	void findBeanByParentTypeBeanName() {
		DiscountPolicy rateDiscount = ac.getBean("rateDiscountPolicy", DiscountPolicy.class);
	...
	void findBeanBySubType() {
		RateDiscountPolicy rateDiscount = ac.getBean("rateDiscountPolicy", RateDiscountPolicy.class);
